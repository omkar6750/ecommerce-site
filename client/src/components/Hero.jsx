  ...
  return (
    <div className='h-[90vh] flex bg-gradient-to-bl from-[#fde1ff] to-[#e1ffea22] '>
        <div className='flex-1 flex flex-col justify-center gap-[20px] pl-[180px] leading-tight'>
            ...
            <div>
                <Button className='flex items-center justify-center gap-4 w-96 h-16 rounded-full text-white font-semibold text-xl bg-red-600 hover:bg-red-500'>Latest Collection</Button>
